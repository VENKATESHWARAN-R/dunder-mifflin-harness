> **Status:** Reference · **Last revised:** 2026-05-03 · **Type:** developer documentation index
...
**These are NOT a roadmap.** The roadmap lives in [`docs/ROADMAP.md`](../ROADMAP.md). These docs describe shipped behaviour through C5.
...
| [components.md](components.md) | C0–C5 component map — what each component shipped, key files, integration points |
